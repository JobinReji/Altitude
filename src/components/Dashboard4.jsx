...
import { BrandDispersionL, BrandDispersion } from "./DashCharts";
  ...
  return (
    <div className="w-full h-full flex flex-col items-center">
      ...
      <div className="w-full p-1 flex justify-end gap-4">
        <button className="activeBtn">Brands</button>
        <button className="inActiveBtn">SKU's</button>
      </div>
      <div className="sm:w-[75%] w-full h-[70vh] overflow-x-auto">
        <div className="w-full flex">
          <div className="sm:w-[70%] min-w-[460px] flex justify-center items-center py-2 border-b-2 border-r-2 border-[#5224B5] font-semibold bg-[#E9E3F6]">
            Brands
          </div>
          <div className="sm:w-[10%] min-w-[200px] flex flex-col justify-center items-center py-2 border-b-2 border-r-2 border-[#5224B5] font-semibold bg-[#E9E3F6]">
            <div>Incidence</div>
            <div>n=300</div>
          </div>
          <div className="sm:w-[10%] min-w-[200px] flex flex-col justify-center items-center py-2 border-b-2 border-r-2 border-[#5224B5] font-semibold bg-[#E9E3F6]">
          ...
          <div className="sm:w-[10%] min-w-[200px] flex flex-col justify-center items-center py-2 border-b-2 border-[#5224B5] font-semibold bg-[#E9E3F6]">
            <div>Value Share</div>
            <div>₹10,000</div>
          </div>
        </div>
        <div className="h-[80%] flex">
          ...
          <div className="sm:w-[10%] min-w-[200px] h-full border-r-2 border-[#5224B5]">
            <BrandDispersion data={[72, 47, 40, 34, 32, 30, 27, 20]} />
          </div>
          <div className="sm:w-[10%] min-w-[200px] h-full border-r-2 border-[#5224B5]">
            <BrandDispersion data={[65, 42, 38, 30, 28, 25, 22, 18]} />
          </div>
          <div className="sm:w-[10%] min-w-[200px] h-full">
            <BrandDispersion data={[50, 40, 35, 30, 25, 20, 15, 10]} />
          </div>
        </div>
      </div>
      <div
